...
\begin{frame}
  ...
  \begin{itemize}
    \item Informal statement and motivation
...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \item planar graphs
    \item $\vdots$
    \item proper-minor closed families
    \item $\vdots$
    \item all graphs
  \end{itemize}
...
\begin{frame}
  ...
  \begin{itemize}[<+->]
    ...
    \begin{itemize}
      ...
      \item \color{brown}{adjacency labelling (universal graphs)}
    \end{itemize}
  \end{itemize}
  \begin{center}
...
\begin{frame}
   ...
   \end{itemize}
   \begin{center}
     \onslide<1->{\includegraphics[width=.3\textwidth]{images/Toroidal_graph_sample}}
     \onslide<3->{\includegraphics[width=.3\textwidth]{images/3-crossing_Heawood_graph}}
   \end{center}
